...
export const UNIVERS2_MISSIONS: Univers2Mission[] = [
  {
    number: 1,
    title: 'La boussole professionnelle',
    shortLabel: 'Boussole',
    description: 'Réfléchissez à votre identité, vos compétences, vos motivations et votre direction professionnelle.',
    availableFor: ['bachelor2', 'pge2'],
  },
  {
    number: 2,
    title: 'Profil LinkedIn réaliste',
    shortLabel: 'Profil LinkedIn',
    description: "Comprenez ce qui rend un profil LinkedIn étudiant crédible pour une recherche de stage.",
    availableFor: ['bachelor2', 'pge2'],
  },
  {
    number: 3,
    title: "Révélateur d'idées LinkedIn",
    shortLabel: 'Idées LinkedIn',
    description: "Trouvez un angle de post LinkedIn personnel, sans le rédiger à votre place.",
    availableFor: ['bachelor2', 'pge2'],
  },
  {
    number: 4,
    title: 'Enquête jobboards',
    shortLabel: 'Jobboards',
    description: "Comprenez l'intérêt de chaque jobboard et choisissez les bons canaux de candidature.",
    availableFor: ['pge2'],
  },
  {
    number: 5,
    ...
    shortLabel: 'Pitch',
    description: "Adaptez votre présentation selon l'interlocuteur et la situation.",
    availableFor: ['pge2'],
  },
  {
    number: 6,
    ...
    description: "Diagnostic, obstacles et plan d'action pour les 30 prochains jours.",
    availableFor: ['pge2'],
  },
]
