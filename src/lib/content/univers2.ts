...
export const UNIVERS2_MISSIONS: Univers2Mission[] = [
  {
    ...
    description: 'Explorez qui vous êtes professionnellement et construisez une image authentique.',
    availableFor: ['bachelor2', 'pge2'],
  },
  {
    number: 2,
    title: 'Réseau & Personal Branding',
    description: 'Développez votre visibilité et cultivez des relations professionnelles durables.',
    availableFor: ['bachelor2', 'pge2'],
  },
  {
    number: 3,
    title: 'Stratégie de Recherche',
    description: "Construisez une stratégie efficace pour trouver votre prochain poste ou stage.",
    availableFor: ['bachelor2', 'pge2'],
  },
  {
    number: 4,
    title: 'Négociation & Closing',
    description: "Maîtrisez l'art de négocier votre valeur et de conclure une opportunité.",
    availableFor: ['pge2'],
  },
  {
    number: 5,
    title: 'Leadership & Management',
    description: 'Développez votre posture de leader et préparez-vous à manager des équipes.',
    availableFor: ['pge2'],
  },
  {
    number: 6,
    title: 'Vision Long Terme',
    description: 'Définissez votre trajectoire de carrière sur 5 à 10 ans avec lucidité.',
    availableFor: ['pge2'],
  },
]
